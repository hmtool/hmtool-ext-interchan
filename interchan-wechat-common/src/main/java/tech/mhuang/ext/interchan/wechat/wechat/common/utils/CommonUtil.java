...
public class CommonUtil {
    ...
    public static String httpsSSLRequest(String requestUrl, String request, String mchid, String sslFileUrl) throws Exception {
        //指定读取证书格式为PKCS12
        KeyStore keyStore = KeyStore.getInstance("PKCS12");
        //读取本机存放的PKCS12证书文件@TODO证书地址
        FileInputStream instream = new FileInputStream(new File(sslFileUrl));
        try {
            //指定PKCS12的密码(商户ID)
